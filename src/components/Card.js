...
function Card({ card, text, link, likesCount, onCardLike, onCardClick, onCardDeleteButtonClick, setSelectedCard }) {
  ...
  return (
    <li className='card'>
      <button aria-label='trash' type='button' className={cardDeleteButtonClassName} onClick={() => handleDeleteClick(card)}></button>
